<div id="add-coupon-modal" tabindex="-1" aria-hidden="true" class="hidden bg-black/30 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-0 p-4 w-full md:inset-0 h-modal md:h-full">
